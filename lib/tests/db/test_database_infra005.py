...
from icarus.db.repository import DatabaseRepository
...
class TestLoadCache:
    ...
    def test_load_cache_with_snapshot(self, repo, snapshot_data_factory):
        repo.take_portfolio_snapshot(snapshot_data_factory())
        cache = repo.load_cache()

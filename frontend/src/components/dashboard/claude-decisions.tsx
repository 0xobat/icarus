...
import { useDashboardDecisions } from "@/lib/hooks/use-dashboard";
...
export function ClaudeDecisions() {
  const { data: claudeDecisionsData, isLoading, stale } = useDashboardDecisions();

  if (isLoading || !claudeDecisionsData) {
    return <SkeletonCard />;
  }
